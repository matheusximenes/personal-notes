...
S ==> Single Responsability - SRP:
    - Breakdown to Single Responsability (Do exactly one thing).
...
0 ==> Open-closed - OCP (Open to Extension, but closed for modification):
    ...
    *** Note 2: Avoid Refactoring code, avoid bugs and is easy to mantain.
...
I ==> Interface Segregation - ISP:
    ...
    *** Note: Only uses what supouse to, avoid extra bugs or extra dependecies.
D ==> Dependency Inversion - DIP:
    ...
    E.g: Form that can be use in diferent places, abstract the onSubmit function to a Parent Component.
    *** Note: Avoid bugs and increase mantainability of the code.


Good Code - Functinal, Maintainable, and Robust
